...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public PageResult pageQuery(EmployeePageQueryDTO employeePageQueryDTO) {
        if (employeePageQueryDTO.getPage() == null || employeePageQueryDTO.getPageSize() == null) {
            throw new com.sky.exception.PageParameterException(MessageConstant.PAGE_PARAMETER_ERROR);
        }
